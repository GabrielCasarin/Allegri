...
DeclaraVariavel = "var" Identificador {"," Identificador} Tipo {"[" Numero "]"}. \end{verbatim}
    ...
    \subsection*{Autômato}
    \addcontentsline{toc}{subsection}{Autômato}
    ...
    \begin{figure}[h]
        ...
        \includegraphics[scale=.5]{submaquinas/Func}
    \end{figure}

    \begin{figure}[h]
        % \centering
        \caption{Submáquina Bloco}
        \includegraphics[scale=.5]{submaquinas/Bloco}
    \end{figure}
    ...
    \begin{figure}[h]
        ...
        \includegraphics[scale=.8]{submaquinas/Expressao}
    \end{figure}
    ...
    \begin{figure}[h]
        ...
        \includegraphics[scale=.7]{submaquinas/Operando}
    \end{figure}
    ...
    \begin{figure}[h]
        ...
        \includegraphics[scale=.6]{submaquinas/IF}
    \end{figure}
    ...
    \begin{figure}[h]
        ...
        \includegraphics[scale=.7]{submaquinas/While}
    \end{figure}
